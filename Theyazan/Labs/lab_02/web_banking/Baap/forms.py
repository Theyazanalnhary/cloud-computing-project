...
class UpdatePasswords(PasswordChangeForm):
    ...
    new_password1 = forms.CharField(widget=forms.PasswordInput(attrs={'class':'form-control form-control-sm rounded-0'}), label="كلمة المرور الجديد")
    new_password2 = forms.CharField(widget=forms.PasswordInput(attrs={'class':'form-control form-control-sm rounded-0'}), label="تاكيد كلمة المرور")
    class Meta:
        model = User
